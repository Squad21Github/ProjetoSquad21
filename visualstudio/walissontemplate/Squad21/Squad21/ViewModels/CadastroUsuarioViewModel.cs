...
namespace Squad21.ViewModels
{
    ...
    public class CadastroUsuarioViewModel
    {
        ...
        [DataType(DataType.EmailAddress, ErrorMessage = "E-mail em informado inválido.")]
        [EmailAddress(ErrorMessage = "E-mail em informado inválido.")]
